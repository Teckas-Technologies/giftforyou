...
type BadgeVariant = 'default' | 'urgent' | 'soon' | 'later' | 'success' | 'info';
...
const Badge = ({ text, variant = 'default', size = 'medium', style }: BadgeProps) => {
  ...
  return (
    <View style={[styles.base, variantStyles.container, size === 'small' && styles.small, style]}>
      <Text style={[styles.textBase, variantStyles.text, size === 'small' && styles.smallText]}>
        {text}
      </Text>
    </View>
  );
...
export const getBadgeVariant = (daysUntil: number): BadgeVariant => {
...
export const formatCountdown = (daysUntil: number): string => {
