...
const LockIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const CheckIcon = ({ size = 14, color = '#4CAF50' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const GoogleIcon = ({ size = 22 }: IconProps) => (
...
const SignUpScreen = ({ navigation }: ScreenProps) => {
  ...
  const isFormValid =
    name.trim().length > 0 && isValidEmail(email) && isValidPassword(password) && passwordsMatch;
    ...
    return (
      <View style={styles.strengthContainer}>
        ...
        <View style={styles.strengthItem}>
          ...
          <Text style={[styles.strengthText, hasNumber && styles.strengthTextValid]}>Number</Text>
        </View>
      </View>
    );
  };
    ...
    >
      ...
      <View style={styles.scrollContent}>
        ...
        >
          ...
          >
            {googleLoading ? (
              <ActivityIndicator color="#6b3a8a" />
            ) : (
              <>
                <GoogleIcon size={22} />
