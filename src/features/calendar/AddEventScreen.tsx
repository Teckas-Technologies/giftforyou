...
const CalendarIcon = ({ size = 24, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const UserIcon = ({ size = 24, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const BellIcon = ({ size = 24, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const RepeatIcon = ({ size = 24, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const ChevronDownIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const AddEventScreen = ({ navigation, route }: ScreenProps) => {
  ...
  const handleSave = async () => {
    ...
    if (eventName.trim().length < 2) {
      showWarning('Event name needed', 'Please enter an event name (at least 2 characters).', [
        { text: 'OK' },
      ]);
      return;
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <MaskedView maskElement={<Text style={styles.headerTitleMask}>Add Event</Text>}>
          <LinearGradient
      ...
      >
        ...
        >
          <LinearGradient
            colors={
              isValid && !saving ? ['#6b3a8a', '#ca9ad6', '#70d0dd'] : ['#ccc', '#ddd', '#ccc']
            }
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
                ...
                <ScrollView style={styles.contactList} showsVerticalScrollIndicator={false}>
                  {contacts.map((c) => (
                    ...
                    >
                      ...
                      {selectedContact?.id === c.id && <CheckIcon size={20} color="#ca9ad6" />}
                    </TouchableOpacity>
                  ))}
                </ScrollView>
              )}
