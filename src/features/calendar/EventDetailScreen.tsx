...
const CalendarIcon = ({ size = 24, color = '#70d0dd' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const BellIcon = ({ size = 24, color = '#f9a825' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const RepeatIcon = ({ size = 24, color = '#4caf50' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const TrashIcon = ({ size = 24, color = '#e53935' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const ChevronRightIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const EventDetailScreen = ({ navigation, route }: ScreenProps) => {
  ...
  const contactName =
    event.contact?.name || event.contactName || event.circle?.nickname || event.circle?.guest_name;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <MaskedView maskElement={<Text style={styles.headerTitleMask}>Event Details</Text>}>
            <LinearGradient
