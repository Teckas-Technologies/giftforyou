...
const SplashScreenComponent = ({ navigation }: ScreenProps) => {
  // Animation refs
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeOut }]} onLayout={onLayoutRootView}>
      <LinearGradient
      ...
      <View style={styles.content}>
        ...
        <Animated.View
          style={[
            ...
            {
              opacity: logoOpacity,
              transform: [{ scale: logoScale }, { scale: glowPulse }],
            },
          ]}
        >
