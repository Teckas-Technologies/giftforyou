...
// Bell Icon
const BellIcon = ({ size = 55, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// User Icon
const UserIcon = ({ size = 28, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const UsersIcon = ({ size = 16, color = '#70d0dd' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Gift Icon
const GiftIcon = ({ size = 55, color = '#70d0dd' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Small Gift Icon
const SmallGiftIcon = ({ size = 16, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Headphones Icon
const HeadphonesIcon = ({ size = 20, color = '#70d0dd' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Book Icon
const BookIcon = ({ size = 20, color = '#70d0dd' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Spa/Cookie Icon
const SpaIcon = ({ size = 20, color = '#f4cae8' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Calendar Icon
const CalendarIcon = ({ size = 16, color = '#70d0dd' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const PartyIcon = ({ size = 65, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Plus Icon
const PlusIcon = ({ size = 18, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Check Icon
const CheckIcon = ({ size = 12, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  const renderItem = ({
    ...
    return (
      <View style={styles.slide}>
        <LinearGradient
          colors={isPink ? ['#FDEEF3', '#D4F1F9', '#FBDCE9'] : ['#D4F1F9', '#EBF5FB', '#B2EBF2']}
          locations={[0, 0.5, 1]}
        ...
        <View style={styles.slideContent}>
          ...
          {index === 3 && (
            <Animated.View
              style={[styles.celebrationIcon, { transform: [{ rotate: wiggleRotate }] }]}
            >
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity onPress={scrollToNext} activeOpacity={0.9}>
            <LinearGradient
              colors={isPink ? ['#f4cae8', '#70d0dd'] : ['#70d0dd', '#f4cae8']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
              style={styles.button}
            >
      ...
      <View style={styles.paginationContainer}>
        {onboardingData.map((item, index) => {
          ...
          return (
            <View
              key={index}
              style={[styles.dot, isActive && [styles.dotActive, { backgroundColor: dotColor }]]}
            />
          );
        })}
      </View>
