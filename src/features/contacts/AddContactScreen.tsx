...
const UserIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const MailIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const CalendarIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const HeartIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const CheckIcon = ({ size = 24, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const WheelPicker = ({
  ...
  const paddedData = [
    ...
    ...data.map((item, index) => ({
      value: item,
      id: keyExtractor ? keyExtractor(item) : `item-${index}`,
    })),
  ...
  const renderWheelItem = useCallback(
    ({ item, index }: { item: any; index: number }) => {
      ...
      return (
        <TouchableOpacity
          style={[wheelStyles.wheelItem, isSelected && wheelStyles.wheelItemSelected]}
          onPress={() => {
        ...
        >
          <Text
            style={[wheelStyles.wheelItemText, isSelected && wheelStyles.wheelItemTextSelected]}
          >
...
const AddContactScreen = ({ navigation, route }: ScreenProps) => {
  ...
  const [selectedMonth, setSelectedMonth] = useState(
    editParts ? editParts.month - 1 : new Date().getMonth(),
  );
  const [selectedDay, setSelectedDay] = useState(editParts ? editParts.day : new Date().getDate());
  const [selectedYear, setSelectedYear] = useState(
    editParts ? editParts.year : new Date().getFullYear(),
  );
  const [relationship, setRelationship] = useState(
    editContact?.relationship?.toLowerCase() || 'friend',
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <MaskedView
          maskElement={
            <Text style={styles.headerTitleMask}>
            ...
            <View style={styles.inputRow}>
              <View
                style={[
                  ...
                  focusedInput === 'name' && styles.iconContainerFocused,
                ]}
              >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        style={
                          isSelected ? styles.relationshipTextSelected : styles.relationshipText
                        }
                      >
                        {type.label}
                      </Text>
          ...
          <Animated.View style={[styles.inputSection, createSlideStyle(inputAnims[4])]}>
            <View style={styles.inputRow}>
              <View
                style={[
                  styles.iconContainer,
                  focusedInput === 'nickname' && styles.iconContainerFocused,
                ]}
              >
