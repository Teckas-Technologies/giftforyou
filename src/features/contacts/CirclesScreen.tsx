...
// Plus Icon
const PlusIcon = ({ size = 22, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    >
      <TouchableOpacity style={styles.circleCardInner} activeOpacity={0.8}>
        ...
        <View style={styles.circleTop}>
          ...
          >
            <LinearGradient
              colors={circle.colorType === 'pink' ? ['#fbe5f5', '#f4cae8'] : ['#ccf9ff', '#a8e6f0']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
        ...
        <View style={styles.avatarsRow}>
          {circle.members.map((initial: string, idx: number) => (
            <Animated.View
              key={idx}
              style={[
    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.header, createFadeStyle(headerAnim)]}>
        <View style={styles.headerLeft}>
          <MaskedView maskElement={<Text style={styles.headerTitleMask}>My Circles</Text>}>
            <LinearGradient
