...
const MailIcon = ({ size = 24, color = '#ca9ad6' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const SendIcon = ({ size = 24, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const PlusIcon = ({ size = 24, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const ClockIcon = ({ size = 16, color = '#f9a825' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const CheckCircleIcon = ({ size = 16, color = '#4caf50' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const XCircleIcon = ({ size = 16, color = '#e53935' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const RefreshIcon = ({ size = 18, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const XIcon = ({ size = 24, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const ShareIcon = ({ size = 18, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const UserPlusIcon = ({ size = 20, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const InvitationsScreen = ({ navigation, route }: ScreenProps) => {
  ...
  // round trip to an endpoint that's only going to 403 anyway.
  const { data: planStatus } = usePlanStatus();
  const invalidatePlanStatus = useInvalidatePlanStatus();
  ...
  // Custom alert hook
  const { alertConfig, showSuccess, showError, showWarning, showInfo, showOptions, hideAlert } =
    useAlert();
  ...
  const handleShareLink = async (inviteLink: string, inviteeName: string) => {
    try {
      await Share.share({
  ...
  const showUpgradePrompt = () => {
    showOptions(
      ...
      [
        {
          text: 'Have a company code? Redeem it here',
  ...
  const handleSendInvitation = async () => {
    ...
    // Cached plan status already told us they're at the limit — skip the
    // request entirely and show the upgrade prompt instantly instead of a
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          <MaskedView maskElement={<Text style={styles.headerTitleMask}>Invite Friends</Text>}>
            <LinearGradient
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#ca9ad6" />
        }
      >
        {/* Stats Cards */}
        ...
        {!loading && filteredInvitations.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Tap + to invite friends via WhatsApp, SMS, or any app. They'll fill a questionnaire
              about their gift preferences.
            </Text>
          </View>
        ) : (
          !loading && (
                    ...
                    <View style={styles.invitationContent}>
                      ...
                      <View style={styles.invitationDetails}>
                        ...
                        <View style={styles.invitationMeta}>
                          ...
                          <Text style={styles.sentTime}>Sent {formatDate(invitation.sent_at)}</Text>
                        </View>
                      </View>
                    </View>
                    <View style={styles.cardActions}>
                      {invitation.status === 'pending' && invitation.inviteLink && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            handleShareLink(invitation.inviteLink as string, invitation.name)
                          }
                        >
      ...
      <Animated.View
        style={[
          ...
          {
            opacity: fabAnim,
            transform: [{ scale: Animated.multiply(fabAnim, fabPulse) }],
          },
        ]}
      >
                  ...
                  >
                    ...
                    >
                      ...
                      <TouchableOpacity
                        style={[
                          styles.sendButton,
                          (!newName.trim() || !newEmail.trim()) && styles.sendButtonDisabled,
                        ]}
                        onPress={() => {
                          Keyboard.dismiss();
