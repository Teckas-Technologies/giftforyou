...
// User Icon
const UserIcon = ({ size = 24, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Calendar Icon
const CalendarIcon = ({ size = 24, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Check Icon
const CheckIcon = ({ size = 16, color = '#FFFFFF' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Chevron Icons
const ChevronUpIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const WheelPicker = ({
    ...
    ({ item, index }: { item: any; index: number }) => {
      ...
      return (
        <TouchableOpacity
          ...
          style={[styles.wheelPickerItem, isSelected && styles.wheelPickerItemSelected]}
        >
          <Text
            style={[styles.wheelPickerItemText, isSelected && styles.wheelPickerItemTextSelected]}
          >
  ...
  const paddedData = [
    ...
    ...data.map((item, index) => ({
      value: item,
      id: keyExtractor ? keyExtractor(item, index) : index.toString(),
    })),
...
const ProfileSetupScreen = ({ navigation, route }: ScreenProps) => {
  ...
  const adjustValue = (type: string, direction: number) => {
    if (type === 'month') {
