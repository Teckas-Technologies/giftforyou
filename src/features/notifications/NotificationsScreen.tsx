...
const CheckAllIcon = ({ size = 20, color = '#6b3a8a' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const TrashIcon = ({ size = 18, color = '#e53935' }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const getNotificationIcon = (type: string, title = '') => {
  switch (type) {
    case 'event_reminder': {
...
const NotificationsScreen = ({ navigation }: ScreenProps) => {
  const [pendingActionIds, setPendingActionIds] = useState<Record<string, string>>({});
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          <MaskedView maskElement={<Text style={styles.headerTitleMask}>Notifications</Text>}>
            <LinearGradient
              ...
              {notifications.map((notification, index) => (
                ...
                >
                  ...
                  >
                    <LinearGradient
                      colors={
                        notification.is_read ? ['#f8f9fa', '#f8f9fa'] : ['#fbe5f5', '#ccf9ff']
                      }
                      start={{ x: 0, y: 0 }}
                      end={{ x: 1, y: 1 }}
                      style={styles.notificationIcon}
