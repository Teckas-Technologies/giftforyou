...
module.exports = {
  expo: {
    ...
    ios: {
      ...
      // Convention is to keep it identical to `version`. Bumped to 0.3.6 for
      // this build (0.3.5 already used) — includes the RevenueCat iOS API
      // key fix so subscription products can actually load.
      buildNumber: '0.3.6',
